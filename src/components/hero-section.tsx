      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-foreground">
            Gamified Sustainable Agriculture Platform
          </h2>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Transform farming through AI-powered missions, community challenges, and real-world rewards. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <Card className="bg-gradient-card border-0 shadow-card p-6 hover:shadow-elegant transition-all duration-300">
              ...
              <h3 className="font-semibold text-card-foreground mb-2">AI-Powered Missions</h3>
              <p className="text-sm text-muted-foreground">Personalized challenges based on your land and crops</p>
            </Card>
            
            <Card className="bg-gradient-card border-0 shadow-card p-6 hover:shadow-elegant transition-all duration-300">
              <Users className="w-8 h-8 text-accent mb-3 mx-auto" />
              <h3 className="font-semibold text-card-foreground mb-2">Community Clans</h3>
              <p className="text-sm text-muted-foreground">Team up with fellow farmers for collective impact</p>
            </Card>
            
            <Card className="bg-gradient-card border-0 shadow-card p-6 hover:shadow-elegant transition-all duration-300">
              <Trophy className="w-8 h-8 text-success mb-3 mx-auto" />
              <h3 className="font-semibold text-card-foreground mb-2">Real Rewards</h3>
              <p className="text-sm text-muted-foreground">Earn discounts, subsidies, and premium marketplace access</p>
            </Card>
          </div>
        </div>
      </div>
